# Estado de entrega actual - Menéndez Pidal

## 1. Excel maestro ingresos 2025 por habitación y mes
**Estado:** hecho y revisado
- archivo principal: `matriz_final_ingresos_por_habitacion_2025_menendez_pidal_v1.csv`
- agosto 2025 ya cuadra exactamente a `812,00 €`
- vacante de Imed no se fuerza aquí con imputación cerrada

## 2. Excel maestro gastos 2025 con prorrateo por habitación
**Estado:** hecho y revisado
- archivo principal: `excel_maestro_gastos_2025_por_habitacion_v1.csv`
- fórmula visible: `gasto total x coeficiente temporal x coeficiente habitación`
- coeficiente habitación apoyado en plano y reparto de comunes
...
**Estado:** hecha
- archivo: `memoria_fiscal_criterio_menendez_pidal_1_pagina_v1.md`
- resume ingresos, gastos, amortizaciones, arrastre 2024 y criterio 50 %
